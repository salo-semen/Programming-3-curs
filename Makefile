#############################################################################
# Makefile for building: Programming-3-curs.app/Contents/MacOS/Programming-3-curs
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  Programming-3-curs.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Programming-3-curs.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Programming-3-curs1.0.0
DISTDIR = /Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs/.tmp/Programming-3-curs1.0.0
...
SOURCES       = src/Apartment.cpp \
		src/Date.cpp \
		src/FileModel.cpp \
		src/main.cpp \
		src/Realty.cpp \
		src/Ui.cpp \
		src/VillageHouse.cpp moc_Ui.cpp
OBJECTS       = Apartment.o \
		Date.o \
		FileModel.o \
		main.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		Programming-3-curs.pro include/Apartment.h \
		include/Date.h \
		include/FileModel.h \
		include/Realty.h \
		include/Ui.h \
		include/VillageHouse.h src/Apartment.cpp \
		src/Date.cpp \
		src/FileModel.cpp \
		src/main.cpp \
		src/Realty.cpp \
...
QMAKE_TARGET  = Programming-3-curs
DESTDIR       = 
TARGET        = Programming-3-curs.app/Contents/MacOS/Programming-3-curs

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs/Programming-3-curs.pro
...
Programming-3-curs.app/Contents/MacOS/Programming-3-curs:  $(OBJECTS)  
	@test -d Programming-3-curs.app/Contents/MacOS/ || mkdir -p Programming-3-curs.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Programming-3-curs.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2_1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile Programming-3-curs.pro
...
Programming-3-curs.app/Contents/PkgInfo: 
	@test -d Programming-3-curs.app/Contents || mkdir -p Programming-3-curs.app/Contents
	@$(DEL_FILE) Programming-3-curs.app/Contents/PkgInfo
	@echo "APPL????" > Programming-3-curs.app/Contents/PkgInfo
Programming-3-curs.app/Contents/Info.plist: 
	@test -d Programming-3-curs.app/Contents || mkdir -p Programming-3-curs.app/Contents
	@$(DEL_FILE) Programming-3-curs.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Programming-3-curs,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Programming-3-curs,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Programming-3-curs,g" -e "s,@LIBRARY@,Programming-3-curs,g" -e "s,\$${EXECUTABLE_NAME},Programming-3-curs,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Programming-3-curs.app/Contents/Info.plist

all: Makefile \
		Programming-3-curs.app/Contents/PkgInfo \
		Programming-3-curs.app/Contents/Info.plist Programming-3-curs.app/Contents/MacOS/Programming-3-curs
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Apartment.h include/Date.h include/FileModel.h include/Realty.h include/Ui.h include/VillageHouse.h $(DISTDIR)/
	$(COPY_FILE) --parents src/Apartment.cpp src/Date.cpp src/FileModel.cpp src/main.cpp src/Realty.cpp src/Ui.cpp src/VillageHouse.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r Programming-3-curs.app
...
moc_Ui.cpp: include/Ui.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs -I/Users/semensalofutdinov/proga/univer/3kurs/programming/Programming-3-curs -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib include/Ui.h -o moc_Ui.cpp
...
Apartment.o: src/Apartment.cpp include/Apartment.h \
		include/Realty.h \
		include/Date.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Apartment.o src/Apartment.cpp

Date.o: src/Date.cpp include/Date.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Date.o src/Date.cpp

FileModel.o: src/FileModel.cpp include/FileModel.h \
		include/Realty.h \
		include/Date.h \
		include/Apartment.h \
		include/VillageHouse.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FileModel.o src/FileModel.cpp

main.o: src/main.cpp include/Realty.h \
		include/Date.h \
		include/Apartment.h \
		include/VillageHouse.h \
		include/FileModel.h \
...
Realty.o: src/Realty.cpp include/Realty.h \
		include/Date.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Realty.o src/Realty.cpp
...
VillageHouse.o: src/VillageHouse.cpp include/VillageHouse.h \
		include/Realty.h \
		include/Date.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o VillageHouse.o src/VillageHouse.cpp
